    ...
    return (
        <>
            <div className="Business_Cards_margin mb-5">
                <div className="Pivacy_heading">Business Seeking Loan</div>
                                ...
                                <Card className="Card_shadow mt-3 ml-2 mr-2 p-2" onClick={() => props.history.push("/business-detail")}>
                                    ...
                                    <div>
                                        <Grid className="Component_main_grid mt-2 p-2">
                                            ...
                                            <Grid item md={3}>
                                                <div>
                                                    <img src="https://www.smergers.com/media/cache/80/b5/80b58f49823d00707dce999c6ff2a866.webp" alt="" className="business_image_style" />
                                                </div>
                                            </Grid>
                                        </Grid>
                                    </div>
...
export default HOC2(BusinessLoan)
