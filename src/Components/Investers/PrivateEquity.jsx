    ...
    return (
        <>
            <div className="Business_Cards_margin mb-5">
                <div className="Pivacy_heading">Private Equity Firms</div>
...
export default HOC2(PrivateEquity)
