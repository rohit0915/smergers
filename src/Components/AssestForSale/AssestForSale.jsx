    ...
    return (
        <>
            <div className="Business_Cards_margin mb-5">
                <div className="Pivacy_heading">Business Assests for Sales</div>
                            ...
                            <Grid item md={4}>
                                <Card className="Card_shadow mt-3 ml-2 mr-2 p-2" onClick={() => props.history.push("/business-detail")}>
                                    ...
                                    <div className="d-flex justify-content-between card_rate_format mt-2">
                                        <span>Ownership Duration <i class="fa fa-info-circle"></i> Meerut</span>
                                        <span>20-30 year(s)</span>
                                    </div>
...
export default HOC2(AssestForSale)
