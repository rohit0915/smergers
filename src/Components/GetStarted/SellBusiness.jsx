    ...
    return (
        <>
            <div className="content_margin mb-5">
                <div className="Pivacy_heading">Business for Sale | Sell My Business</div>
                <div>
                    <p className="Privacy_content">We understand that selling your business is a tedious and time-consuming process , but is also one of
                        the most important events of your career. Whether you plan to retire from your company, relocate to
                        a new location, move on to new opportunities, or you feel that the company
                        needs a larger backing, selling your business to an interested entrepreneur is the best option.</p>
                    <p className="Privacy_content">Confidentiality of your business and the quality of buyers you speak with are of prime importance to us.
                        On our platform, you can expand your reach by
                        connecting with a large number of registered buyers for private placements on a confidential basis.</p>
                    <p className="Privacy_content">SMERGERS helps you to connect with targeted buyers who can take your business to the next level.</p>
                </div>

                <div className="mt-5 mb-5">
                    <iframe width="100%" height="700" src="https://www.youtube.com/embed/R9ReEI1vn-8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                ...
                <div className="mt-3 mb-3 text-center">
                    <p className="Privacy_content">Note: All prices are inclusive of taxes. All plans have access to Business Dashboard, Interested
...
export default withRouter(HOC1(SellBusiness));
