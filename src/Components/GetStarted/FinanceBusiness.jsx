    ...
    return (
        <>
            <div className="content_margin mb-5">
                <div className="Pivacy_heading">Find Investors for your Business</div>
                <div>
                    <p className="Privacy_content">More than 60% of SMEs are unserved or underserved by the current
                        financial ecosystem. Businesses can access finance through "equity financing" or "debt financing“ .
                        Equity financing means you give a share of your company for money.
                        Debt financing means that you will pay back the money with a predefined interest amount.</p>
                    <p className="Privacy_content">Apart from bank loans, one can raise funds from various other
                        viable sources such as friends, family, private lenders, individual investors,
                        angel investors, NBFCs, PE firms and other companies seeking to make strategic investments.</p>
                    <p className="Privacy_content">SMERGERS helps you to connect with the right investors who can fuel business growth.</p>
                </div>
...
export default withRouter(HOC1(FinanceBusiness));
